...
process_lines([], Sum_Of_Powers) ->
	Sum_Of_Powers;
process_lines([Line|Lines], Sum_Of_Powers) ->
	[_, Results_Part_Str] = string:tokens(Line, ":"),
	Results_Parts = string:tokens(Results_Part_Str, " ,;"),
	process_lines(Lines, new_sum_of_powers(Sum_Of_Powers, get_max_cubes_by_colour(Results_Parts))).
...
new_sum_of_powers(Sum_Of_Powers, {Max_Red, Max_Green, Max_Blue}) ->
